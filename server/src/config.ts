...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'ZeroWeb';
    ...
    'jhipster.mail.from' = 'ZeroWeb@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'ZeroWeb API';
    'jhipster.swagger.description' = 'ZeroWeb API documentation';
    ...
    'eureka.instance.appname' = 'ZeroWeb';
    'eureka.instance.instanceId' = 'ZeroWeb:${random.value}';
